...
<script src="http://maps.google.com/maps?file=api&v=2&key=AIzaSyDAfxPmcZmE6WBOWH_OjUjFqFvSdPtXWaQ" type="text/javascript"></script>
...
<script type="text/javascript">
	if (GBrowserIsCompatible())
	{
		...
		map.setCenter( new GLatLng(0.5070628154890728, 101.44805035605714), 14,0);
