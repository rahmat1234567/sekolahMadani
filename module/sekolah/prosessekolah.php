...
elseif($aksi == "update"){
	$db->update($_POST['id_sklh'],$_POST['nama_sklh'],$_POST['alamat_sklh'],$_POST['telp_sklh'],$_POST['email_sklh'],$_POST['jmlh_siswa'],$_POST['luas_sklh'],$_POST['jlmh_ruang_kls'],$_POST['laboratorium'],$_POST['mushola'],$_POST['aula'],$_POST['lap_basket'],$_POST['lap_sepakbola'],$_POST['longi'],$_POST['lati']);
	header("location:http://localhost/sekolahMadani/admin.php?module=sekolah&kls=semua");
}
?>