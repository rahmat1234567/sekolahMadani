...
if($aksi == "tambah"){
    ...
    $db->input($namaa,$_POST['nip'],$_POST['nama_guru'],$_POST['jk'],$_POST['wk_status'],$_POST['id_sklh'],$_POST['alamat_guru'],$_POST['telp_guru'],$pass,$_POST['status_akun']);
...
elseif($aksi == "update"){
    ...
    $db->update($namaa,$_POST['nip'],$_POST['nama_guru'],$_POST['jk'],$_POST['wk_status'],$_POST['alamat_guru'],$_POST['telp_guru'],$pass,$_POST['status_akun']);
